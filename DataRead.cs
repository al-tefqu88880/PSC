    ...
    void AttributeValues()
    {
        ...
        foreach (string[] line in data)
        {
            ...
            if (string.Equals(line[2], "1"))
            {
                ...
                RunningBackEnd.tilemap.SetValue(position, "temperature2020", float.Parse(line[3], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "isothermality2020", float.Parse(line[4], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "summerTemperature2020", float.Parse(line[5], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "rain2020", float.Parse(line[6], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rainVariation2020", float.Parse(line[7], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "summerRain2020", float.Parse(line[8], CultureInfo.InvariantCulture));
                ...
                RunningBackEnd.tilemap.SetValue(position, "temperature2040", float.Parse(line[14], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "isothermality2040", float.Parse(line[15], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "summerTemperature2040", float.Parse(line[16], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rain2040", float.Parse(line[17], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rainVariation2040", float.Parse(line[18], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "summerRain2040", float.Parse(line[19], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "temperature2060", float.Parse(line[20], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "isothermality2060", float.Parse(line[21], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "summerTemperature2060", float.Parse(line[22], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rain2060", float.Parse(line[23], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rainVariation2060", float.Parse(line[24], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "summerRain2060", float.Parse(line[25], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "temperature2080", float.Parse(line[26], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "isothermality2080", float.Parse(line[27], CultureInfo.InvariantCulture) / 10);
                RunningBackEnd.tilemap.SetValue(position, "summerTemperature2080", float.Parse(line[28], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rain2080", float.Parse(line[29], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "rainVariation2080", float.Parse(line[30], CultureInfo.InvariantCulture));
                RunningBackEnd.tilemap.SetValue(position, "summerRain2080", float.Parse(line[31], CultureInfo.InvariantCulture));
            }
